...
class PostProcessor:
    def __init__(self, json_config, zoo_path):
        ...
        label_path = os.path.join(zoo_path, label_path)
    ...
    def _dequantize(self, tensor_list):
        """
        ...
        for tensor, anchor_meta in zip(tensor_list, self.anchor_info):
    ...
    def forward(self, tensor_list):
        ...
        loc, conf, landms = self._dequantize(tensor_list)
